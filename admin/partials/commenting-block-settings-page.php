...
<div class="cf-plugin-settings">
    <div class="cf-plugin-header">
        ...
        <h1><?php esc_html_e( 'Multicollab - Editorial Commenting for WordPress', 'content-collaboration-inline-commenting' ); ?></h1>
    </div>
                    ...
                    <div class="cf-tabs-content">
                        <div id="cf-dashboard" class="cf-tab-inner cf-tab-active">
                            <div class="cf-content-simple">
                                ...
                                <?php endif; ?>
                                <div class="cf-video">
                                    <iframe width="970" height="530" src="https://www.youtube-nocookie.com/embed/rDdgh_u8oVQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                                <div class="cf-video-links">
                                    ...
                                    <div class="cf-link-wrap">
                                        <p><a href="https://www.multidots.com/google-doc-style-editorial-commenting-for-wordpress/" class="cf-link" target="_blank" id="cf-demo"><?php esc_html_e( 'Learn More', 'content-collaboration-inline-commenting' ); ?></a> <?php esc_html_e( 'About Plugin', 'content-collaboration-inline-commenting' ); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="cf-right">
                <div id="cf-developer" class="cf-card">
                    ...
                    <div class="cf-card-body">
                        ...
                        <a href="https://www.multidots.com/" target="_blank" class="cf-button button button-primary"><?php esc_html_e( 'Visit Site', 'content-collaboration-inline-commenting' ); ?></a>
                    </div>
                </div>
                <div id="cf-contact" class="cf-card">
                    ...
                    <div class="cf-card-body">
                        ...
                        <a href="https://www.multidots.com/google-doc-style-editorial-commenting-for-wordpress/#mdinc-contact-form-1" target="_blank" class="cf-button button button-primary"><?php esc_html_e( 'Contact Us', 'content-collaboration-inline-commenting' ); ?></a>
                    </div>
                </div>
            </div>
        </div>
