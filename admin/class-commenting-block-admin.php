			...
			foreach ( $resolved_drafts as $el ) {
				...
				if ( ! empty( $comments ) && is_array( $comments ) ) {
					...
					<style>
						...
						.comment-box .comment-box-wrap .commenter-name{font-size:18px;font-family:Roboto,Arial,sans-serif;margin-right:7px;color:#141414;font-weight:600;}
						...
						.comment-box .head-with-icon .icon-comment{margin-right:10px;}
						...
						.comment-box .cf-marked-resolved-by .icon-resolved{margin-right:5px;}
										...
										<div class='comment-box-wrap'>
											...
											<div class='comment-details'>
												<div class='commenter-name-role'>
													...
													<div class='commenter-role'>( " . esc_html( ucwords( $user_role ) ) . " )</div>
												</div>
