<div class="cf-need-help-panel">
    <div class="cf-need-help-panel__inner">
        <div class="cf-need-help-panel__inner-left">
            <h3><?php esc_html_e( 'How to Get Started', 'content-collaboration-inline-commenting' ); ?></h3>
            <h2><?php esc_html_e( 'Welcome to Multicollab', 'content-collaboration-inline-commenting' ); ?></h2>
            <p>
                <?php esc_html_e( 'Multicollab is a WordPress plugin designed to enhance editorial workflows by introducing Google Docs-style collaboration features directly into the Gutenberg editor.', 'content-collaboration-inline-commenting' ); ?>
            </p>
            <p>
                <?php esc_html_e( 'It streamlines the content creation process by enabling real-time collaboration, inline commenting, and suggestion modes within WordPress, eliminating the need to switch between external tools.', 'content-collaboration-inline-commenting' ); ?>
            </p>
            <div class="cf-need-help-panel__inner-btnwrap">
                ...
                <g>
                    ...
                    <?php esc_html_e( 'Read the setup guide', 'content-collaboration-inline-commenting' ); ?>
                </a>
            </div>
        </div>
        <div class="cf-need-help-panel__inner-right">
