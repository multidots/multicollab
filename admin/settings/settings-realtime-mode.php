<form class="cf-settings-panel__repeater-body" method="post" id ="cf_multiedit_mode">
	...
	<div class="cf-suggestion-option ">
		<div class="cf-notification-settings multiedit-websocket-settings">
			<!-- <div class="cf-websocket"> -->
				...
				<label for="cf_websocket_default">
					<span class="cf-suggestion-option label"><?php printf( '%s', esc_html__( "Use Multicollab's complimentary WebSocket service.", 'content-collaboration-inline-commenting' ) ); ?>
		...
		<div class="cf-notification-settings multiedit-websocket-settings">
			<div class="cf-websocket">
				...
				<label for="cf_websocket_custom">
					<span class="cf-suggestion-option label"><?php printf( '%s', esc_html__( 'Your WebSocket URL:', 'content-collaboration-inline-commenting' ) ); ?>
						<span class="md-plugin-tooltip">
							<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 3.2c-4.8 0-8.8 3.9-8.8 8.8 0 4.8 3.9 8.8 8.8 8.8 4.8 0 8.8-3.9 8.8-8.8 0-4.8-4-8.8-8.8-8.8zm0 16c-4 0-7.2-3.3-7.2-7.2C4.8 8 8 4.8 12 4.8s7.2 3.3 7.2 7.2c0 4-3.2 7.2-7.2 7.2zM11 17h2v-6h-2v6zm0-8h2V7h-2v2z"></path></svg>
								<div class="cf-suggestion-tooltip-box">
									<a href="#." class="cf-tooltip-close"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path id="Icon_material-close" data-name="Icon material-close" d="M27.5,9.514,25.486,7.5,17.5,15.486,9.514,7.5,7.5,9.514,15.486,17.5,7.5,25.486,9.514,27.5,17.5,19.514,25.486,27.5,27.5,25.486,19.514,17.5Z" transform="translate(-7.5 -7.5)" fill="#000"></path></svg></a>
		...
		<div class="cf-notification-settings">
			<div class="cf-check-wrap">
				<input type="checkbox" name="cf_realtime_for_same_block" class="cf-checkbox" id="cf_realtime_for_same_block" value="true" class="regular-text" <?php echo $cf_realtime_for_same_block ? 'checked' : ''; ?>/>
				<span class="cf-check"></span>
			</div>
			<label for="cf_realtime_for_same_block">
				<span class="cf-suggestion-option label"><?php printf( '%s', esc_html__( 'Restrict Multiple Users to Edit same Block.', 'content-collaboration-inline-commenting' ) ); ?>
					<span class="md-plugin-tooltip">
						<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 3.2c-4.8 0-8.8 3.9-8.8 8.8 0 4.8 3.9 8.8 8.8 8.8 4.8 0 8.8-3.9 8.8-8.8 0-4.8-4-8.8-8.8-8.8zm0 16c-4 0-7.2-3.3-7.2-7.2C4.8 8 8 4.8 12 4.8s7.2 3.3 7.2 7.2c0 4-3.2 7.2-7.2 7.2zM11 17h2v-6h-2v6zm0-8h2V7h-2v2z"></path></svg>
						<div class="cf-suggestion-tooltip-box">
							<a href="#." class="cf-tooltip-close"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path id="Icon_material-close" data-name="Icon material-close" d="M27.5,9.514,25.486,7.5,17.5,15.486,9.514,7.5,7.5,9.514,15.486,17.5,7.5,25.486,9.514,27.5,17.5,19.514,25.486,27.5,27.5,25.486,19.514,17.5Z" transform="translate(-7.5 -7.5)" fill="#000"></path></svg></a>
							<div style="display:flex;align-items;flex-start;"><span><?php esc_html_e( "If selected this option, Multiple users can't edit same block in realtime editing. By default, editing in same block is allowed for multiple users.", 'content-collaboration-inline-commenting' ); ?></span> </div> 
						</div>
					</span>
				</span>
			</label>
