<form class="cf-settings-panel__repeater-body" method="post" id="cf_suggestion_settings">
	<div id="cf-notice">
		...
		<div class="cf-suggestion-option cf_publishing_option">
			<div class="cf-notification-settings">
				...
				<label for="cf_give_alert_message">
					<span class="cf-suggestion-option label "><?php printf( '<b>%s</b> %s <b>%s</b>', esc_html__( 'Remind', 'content-collaboration-inline-commenting' ), esc_html__( 'authors of pending comments before publishing while still', 'content-collaboration-inline-commenting' ), esc_html__( 'allowing publish the post.', 'content-collaboration-inline-commenting' ) ); ?>
