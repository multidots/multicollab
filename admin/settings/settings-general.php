<form class="cf-cnt-box-body" method="post" id ="cf_settings">
	...
	<div class="cf_suggestion_option cf_publishing_option cf_general_option">
		<div class="cf-notification-settings">
			...
			<label for="cf_hide_editorial_column">
				<span class="cf_suggestion_optionlabel">
					<?php printf( '%s <b>%s</b> %s', esc_html__( 'Hide the', 'content-collaboration-inline-commenting' ), esc_html__( 'Editorial Comments', 'content-collaboration-inline-commenting' ), esc_html__( 'column on the Post Lists.', 'content-collaboration-inline-commenting' ) ); ?>
					<span class="md-plugin-tooltip">
						<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 3.2c-4.8 0-8.8 3.9-8.8 8.8 0 4.8 3.9 8.8 8.8 8.8 4.8 0 8.8-3.9 8.8-8.8 0-4.8-4-8.8-8.8-8.8zm0 16c-4 0-7.2-3.3-7.2-7.2C4.8 8 8 4.8 12 4.8s7.2 3.3 7.2 7.2c0 4-3.2 7.2-7.2 7.2zM11 17h2v-6h-2v6zm0-8h2V7h-2v2z"></path></svg>
							<div class="cf_suggestion-tooltip-box">
								...
								<div style="display:flex;align-items:flex-start;"><img src="<?php echo esc_url( COMMENTING_BLOCK_URL . '/admin/assets/images/editorial.png' ); ?>"> <span><?php esc_html_e( 'This column will disappear from the Post List if this is checked.', 'content-collaboration-inline-commenting' ); ?></span> </div> 
							</div>
					</span>
				</span> 
			</label> 
		...
		?>
		<div class="cf-notification-settings <?php echo esc_html( $disabled_class ); ?>">
			<div class="cf-check-wrap">
				<input type="checkbox" name="cf_hide_floating_icons" class="cf-checkbox" id="cf_hide_floating_icons" <?php echo '1' === $cf_hide_floating_icons ? 'checked' : ''; ?> value="1" class="regular-text" <?php echo esc_html( $disabled ); ?>/>
				<span class="cf-check"></span>
			</div>
