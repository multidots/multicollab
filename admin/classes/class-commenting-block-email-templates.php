...
class Commenting_Block_Email_Templates
{
    ...
    public function cf_email_resolved_thread($args)
    {
        ...
        if (! empty($list_of_comments) && is_array($list_of_comments)) {
            ...
            $html .= '<span class="icon-resolved" style="padding-right:5px;line-height:1;vertical-align:middle;"><img src="'.esc_url_raw(COMMENTING_BLOCK_URL . 'admin/assets/images/icon-check.png').'" alt="resolved by" /></span>';
    ...
    public function cf_email_new_comments($args)
    {
        ...
        if (! empty($list_of_comments)) {
            ...
            if (! empty($assign_to)) {
                ...
                <div class='comment-assigned-to' style='padding-bottom:20px;'>
					<span class='icon-assign' style='padding-right:5px;line-height:1;vertical-align:middle;'>
						<img src='".esc_url_raw(COMMENTING_BLOCK_URL . 'admin/assets/images/icon-assign.png')."' alt='Assigned to' />
					</span>
            ...
            $comment_icon_html = "<img src='".esc_url_raw(COMMENTING_BLOCK_URL . 'admin/assets/images/icon-comment.png')."' alt='Icon Comment' style='vertical-align:middle;padding-right:10px;' />";
            ...
            if (! empty($el_obj)) {
                ...
                } elseif ($el_obj['assigned_to'] > 0 && $el_obj['sent_assigned_email'] === true) {
                    // Remove assigned email from the list.
                    $assigned_user = get_user_by('ID', $el_obj['assigned_to']);
